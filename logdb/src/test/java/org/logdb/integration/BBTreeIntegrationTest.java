...
public class BBTreeIntegrationTest
{
    ...
    void shouldBeABleToCreateNewDbFileAndReadLeafNode()
    {
        ...
        final BTree bTree = createNewPersistedBtree(file);
        ...
        final BTree readBTree = loadPersistedBtree(file);
    ...
    void shouldBeABleToPersistAndReadABBtree()
    {
        ...
        final File file = tempDirectory.resolve(filename).toFile();
        final BTree originalBTree = createNewPersistedBtree(file);
        ...
        final BTree loadedBTree = loadPersistedBtree(file);
    ...
    void shouldBeABleToCommitMultipleTimes()
    {
        ...
        final BTreeImpl loadedBTree = loadPersistedBtree(file);
    ...
    void shouldGetHistoricValuesFromOpenDBWithLog()
    {
        ...
        final File file = tempDirectory.resolve(filename).toFile();
        final BTreeWithLog originalBTree = createNewPersistedLogBtree(file);
        ...
        final BTreeWithLog loadedBTree = loadPersistedLogBtree(file);
