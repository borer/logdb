...
class Fletcher64Test
{
    ...
    {
        assertEquals(0, fletcher64.getValue());
    }
    ...
    void shouldCalculateCorrectChecksum()
    {
        ...
        assertEquals(-1152974287884359521L, fletcher64.getValue());
    }
    ...
    void shouldCalculateCorrectChecksumAfterMultipleUpdates()
    {
        ...
        assertEquals(-555887298L, fletcher64.getValue());
    }
    ...
    void shouldCalculateCorrectChecksumAfterReset()
    {
        ...
        fletcher64.reset();
        fletcher64.update("987654321".getBytes());
        assertEquals(-2594093011328668513L, fletcher64.getValue());
    }
    ...
    void shouldCalculateCorrectChecksumForLongMessage()
    {
        ...
        assertEquals(-1098996506L, fletcher64.getValue());
    }
}